...
public class Ketama<T> {
    ...
    public Ketama(List<T> nodes) throws NoSuchAlgorithmException {
        this(4, nodes);
    }

    public Ketama(int virtual, List<T> nodes) throws NoSuchAlgorithmException {
